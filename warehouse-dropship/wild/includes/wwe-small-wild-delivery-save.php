...
if (!class_exists("EnWweSmallWooWdAddonsAjaxReqIncludes")) {

    class EnWweSmallWooWdAddonsAjaxReqIncludes
    {
        ...
        public function __construct()
        {
            ...
            add_action('wp_ajax_nopriv_en_wd_delete_dropship', array($this, 'wwe_small_delete_dropship_ajax'));
            add_action('wp_ajax_en_wd_delete_dropship', array($this, 'wwe_small_delete_dropship_ajax'));

            add_action('wp_ajax_nopriv_en_wwe_small_wd_save_warehouse', array($this, 'wwe_small_save_warehouse_ajax'));
            add_action('wp_ajax_en_wwe_small_wd_save_warehouse', array($this, 'wwe_small_save_warehouse_ajax'));

            add_action('wp_ajax_nopriv_en_wwe_small_wd_save_dropship', array($this, 'wwe_small_save_dropship_ajax'));
            add_action('wp_ajax_en_wwe_small_wd_save_dropship', array($this, 'wwe_small_save_dropship_ajax'));


            add_action('wp_ajax_nopriv_en_wwe_small_wd_edit_dropship', array($this, 'wwe_small_edit_dropship_ajax'));
            add_action('wp_ajax_en_wwe_small_wd_edit_dropship', array($this, 'wwe_small_edit_dropship_ajax'));

            add_action('wp_ajax_nopriv_en_wwe_small_wd_delete_warehouse', array($this, 'wwe_small_delete_warehouse_ajax'));
            add_action('wp_ajax_en_wwe_small_wd_delete_warehouse', array($this, 'wwe_small_delete_warehouse_ajax'));

            add_action('wp_ajax_nopriv_en_wwe_small_wd_edit_warehouse', array($this, 'wwe_small_edit_warehouse_ajax'));
            add_action('wp_ajax_en_wwe_small_wd_edit_warehouse', array($this, 'wwe_small_edit_warehouse_ajax'));
        }
        ...
        function get_address_api_ajax()
        {
            if (isset($_POST['origin_zip'])) {
                ...
                $accessLevel = 'address';
                $Get_sm_distance = new Get_sm_distance();
                ...
                if (isset($validateData["city"])) {
                    ...
                    if ($get_warehouse_id && (empty($get_warehouse) || (!empty($get_warehouse) && reset($get_warehouse)->id == $get_warehouse_id))) {
                        ...
                        if (empty($get_warehouse)) {
                            ...
                            $html = wwe_small_warehouse_template(TRUE);
                        }
                    }
                }
...
//              save correct city for WorldWide Express              
                ...
                wwe_small_get_all_warehouse_dropship($addresses);
                ...
                if (isset($validateData["city"])) {
                    ...
                    if ($get_dropship_id != '' && (empty($get_dropship) || (!empty($get_dropship) && reset($get_dropship)->id == $get_dropship_id))) {
                        ...
                        if (empty($get_dropship)) {
                            ...
                            $html = wwe_small_dropship_template(TRUE);
                        }
                    }
                }
                $lastid = $wpdb->insert_id;
...
new EnWweSmallWooWdAddonsAjaxReqIncludes();