...
<script type="text/javascript">
    ...
    function change_dropship_zip()
    {
        ...
        jQuery('#en_wd_dropship_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-wwe-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-wwe-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('.city_select_css').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-wwe-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-wwe-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
...
<?php wwe_small_dropship_template(); ?>
...
?>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" class="<?php echo $disabled; ?>" title="In-store pick up fee" data-optional="1"
                               onchange="validate_delivery_fee(this);" id="instore-pickup-fee"
                               name="instore-pickup-fee" maxlength="10">
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" class="<?php echo $disabled; ?>" title="Local delivery fee" data-optional="1" onchange="validate_delivery_fee(this);" id="local-delivery-fee" name="local-delivery-fee" maxlength="10">
                        <span class="en_wd_err"></span>
                    </div>
                    <div class="en_wd_add_warehouse_input">
                    ...
                    -->
                    <div class="form-btns">
                        <input type="submit" name="en_wd_submit_dropship" value="Save" class="wwe_small_save_warehouse_form" onclick="return en_wwe_small_wd_save_dropship();">
                    </div>
                </form>
            </div>
        </div>
