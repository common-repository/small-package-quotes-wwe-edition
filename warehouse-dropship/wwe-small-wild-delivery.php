...
if (!function_exists("en_wwe_small_woo_wd_admin_script_style")) {
    ...
    function en_wwe_small_woo_wd_admin_script_style() {
        ...
        wp_enqueue_script('en_wwe_small_woo_wd_script', plugin_dir_url(__FILE__) . '/wild/assets/js/wwe_small_warehouse_section.js', [], '2.0.4');
        wp_localize_script('en_wwe_small_woo_wd_script', 'script', array(
            'pluginsUrl' => plugins_url(),
        ));

        wp_register_style('wwe_small_warehouse_section', plugin_dir_url(__FILE__) . '/wild/assets/css/wwe_small_warehouse_section.css', false, '2.0.2');
        ...
        if (count($warehous_list) > 0) {
            ...
            foreach ($warehous_list as $list) {
                ...
                <?php echo ( isset($list->country) ) ? esc_attr($list->country) : ''; ?>
                                ...
                                <td class="en_wd_warehouse_list_data">
                                    <a href="javascript(0)" onclick="return en_wwe_small_wd_edit_warehouse(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo plugins_url(); ?>/small-package-quotes-wwe-edition/warehouse-dropship/wild/assets/images/edit.png" title="Edit"></a>
                                    <a href="javascript(0)" onclick="return en_wwe_small_wd_delete_current_warehouse(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo plugins_url(); ?>/small-package-quotes-wwe-edition/warehouse-dropship/wild/assets/images/delete.png" title="Delete"></a>
                                </td>
                            </tr>
                <?php
                $count++;
            ...
            foreach ($dropship_list as $list) {
                ?>
                                ...
                                <?php echo ( isset($list->city) ) ? esc_attr($list->city) : ''; ?>
                                    ...
                                    <td class="en_wd_dropship_list_data">
                                        <a href="javascript(0)" onclick="return en_wwe_small_wd_edit_dropship(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo plugins_url(); ?>/small-package-quotes-wwe-edition/warehouse-dropship/wild/assets/images/edit.png" title="Edit"></a>
                                        <a href="javascript(0)" onclick="return en_wwe_small_wd_delete_current_dropship(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo plugins_url(); ?>/small-package-quotes-wwe-edition/warehouse-dropship/wild/assets/images/delete.png" title="Delete"></a>
                                    </td>
                                </tr>
                                        <?php
                                        $count++;
