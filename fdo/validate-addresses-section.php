<?php
/**
 * WWE small Validate addresses Template
 *
            ...
            ?>
                <div id="message" class="en-coupon-code-div woocommerce-message en-coupon-notice">
                    ...
                    <p>
                        ...
                        <a href="javascript:void(0)" onclick="en_wwe_small_va_connection_status_refresh(this);">this link</a>
        ...
        <?php
            ...
            <div id="message" class="en-coupon-code-div woocommerce-message en-coupon-notice">
                ...
                <div class='en-coupon-btn-div'>
                    <button class="en_va_wwe_small_apply_promo_btn button" data-coupon="<?php echo $va_coupon_data['coupon'] ?>"><?php _e( 'Apply Promo Code', 'woocommerce' ); ?></button>
                </div>
            </div>
        <?php
        }
