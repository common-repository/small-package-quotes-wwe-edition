...
if (!class_exists("EnWweSmallWDQuotes")) {

    class EnWweSmallWDQuotes
    {

        public function __construct()
        {
            add_filter('en_wd_update_query_string', array($this, 'en_wd_update_query_string'), 10, 1);
            add_filter('en_wwe_small_wd_origin_array_set', array($this, 'en_wwe_small_wd_origin_array_set'), 10, 1);
            add_filter('en_wwe_small_wd_standard_plans', array($this, 'en_wwe_small_wd_standard_plans'), 10, 4);
        ...
        public function en_wwe_small_wd_standard_plans($post_data, $destination_zip, $origin_array, $package_plugin)
        {
            $action = $this->check_package_plan($package_plugin);
            if ($action) {
                return $post_data;
        ...
        public function en_wd_update_query_string()
        {
            ...
            return " ,phone_instore, enable_store_pickup , fee_local_delivery , fee_store_pickup , suppress_local_delivery , miles_store_pickup , match_postal_store_pickup , checkout_desc_store_pickup , enable_local_delivery , miles_local_delivery , match_postal_local_delivery , checkout_desc_local_delivery , origin_markup";
        }
         ...
         * @return array type
         */
        public function en_wwe_small_wd_origin_array_set($origin)
        {
            ...
            $corrected_city = (isset($origin->wwe_correct_city)) ? $origin->wwe_correct_city : "";
